...
public class ProjectSerialCommunication extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SinglePageAurdino frame1 = new SinglePageAurdino();
	 ...
	 * Create the frame.
	 */
	public  ProjectSerialCommunication() {
		...
		textField_6.setBounds(343, 333, 171, 20);
		...
		btnOnL1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(btnOnL1.getText().equals("L1 On")) {
					// attempt to connect to the serial port
					chosenPort = SerialPort.getCommPort(portList.getSelectedItem().toString());
					chosenPort.setComPortTimeouts(SerialPort.TIMEOUT_SCANNER, 0,16);
					if(chosenPort.openPort()) {
						btnOnL1.setText(" L1 Off");
						portList.setEnabled(false);
						outPut.print("1");
